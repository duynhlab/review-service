...
func validConfig() *Config {
	c := &Config{}
	c.Service = ServiceConfig{Name: "review", Port: "8080", Env: "production"}
	c.Tracing = TracingConfig{Enabled: true, Endpoint: "otel:4318", SampleRate: 0.1, ServiceName: "review"}
	c.Profiling = ProfilingConfig{Enabled: true, Endpoint: "pyro:4040", ServiceName: "review"}
